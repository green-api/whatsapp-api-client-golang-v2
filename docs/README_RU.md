...
| Как получить историю состояний инстанса                   | [getStateInstanceHistory/main.go](/examples/getStateInstanceHistory/main.go)                             |
| Как обновить API-токен                                    | [updateApiToken/main.go](/examples/updateApiToken/main.go)                                               |
| Как получить журнал входящих звонков                      | [lastIncomingCalls/main.go](/examples/lastIncomingCalls/main.go)                                         |
| Как получить журнал исходящих звонков                     | [lastOutgoingCalls/main.go](/examples/lastOutgoingCalls/main.go)                                         |
| Как получить количество вебхуков в очереди                | [getWebhooksCount/main.go](/examples/getWebhooksCount/main.go)                                           |
| Как очистить очередь вебхуков                             | [clearWebhooksQueue/main.go](/examples/clearWebhooksQueue/main.go)                                       |
| Как изменить настройки группы                             | [updateGroupSettings/main.go](/examples/updateGroupSettings/main.go)                                     |
| Как получить список чатов                                 | [getChats/main.go](/examples/getChats/main.go)                                                           |
| Как получить список контактов с фильтрацией               | [getContacts/main.go](/examples/getContacts/main.go)                                                     |
...
| `Account().GetStateInstanceHistory` | Метод предназначен для получения истории состояний инстанса                                                         | [GetStateInstanceHistory](https://green-api.com/docs/api/account/GetStateInstanceHistory/)               |
| `Account().UpdateApiToken`        | Метод предназначен для обновления API-токена инстанса                                                                    | [UpdateApiToken](https://green-api.com/docs/api/account/UpdateApiToken/)                                 |
| `Account().GetDeviceInfo`         | Метод предназначен для получения информации об устройстве                                                                | [GetDeviceInfo](https://green-api.com/docs/api/phone/GetDeviceInfo/)                                     |
...
| `Groups().UpdateGroupSettings`    | Метод предназначен для обновления настроек группового чата                                                                    | [UpdateGroupSettings](https://green-api.com/docs/api/groups/UpdateGroupSettings/)                        |
...
| `Journals().LastIncomingCalls`    | Метод возвращает журнал входящих звонков аккаунта                                                                         | [LastIncomingCalls](https://green-api.com/docs/api/journals/LastIncomingCalls/)                           |
| `Journals().LastOutgoingCalls`    | Метод возвращает журнал исходящих звонков аккаунта                                                                        | [LastOutgoingCalls](https://green-api.com/docs/api/journals/LastOutgoingCalls/)                           |
...
| `Queues().GetWebhooksCount`       | Метод предназначен для получения количества вебхуков в очереди                                                        | [GetWebhooksCount](https://green-api.com/docs/api/queues/GetWebhooksCount/)                              |
| `Queues().ClearWebhooksQueue`     | Метод предназначен для очистки очереди вебхуков                                                                       | [ClearWebhooksQueue](https://green-api.com/docs/api/queues/ClearWebhooksQueue/)                          |
...
| `Sending().SendButtons`           | Метод предназначен для отправки кнопок (временно не работает)                                                         | [SendButtons](https://green-api.com/docs/api/sending/SendButtons/)                                       |
| `Sending().SendTemplateButtons`   | Метод предназначен для отправки шаблонных кнопок (временно не работает)                                               | [SendTemplateButtons](https://green-api.com/docs/api/sending/SendTemplateButtons/)                       |
| `Sending().SendListMessage`       | Метод предназначен для отправки сообщения со списком выбора (временно не работает)                                    | [SendListMessage](https://green-api.com/docs/api/sending/SendListMessage/)                               |
...
| `Service().GetChats`              | Метод предназначен для получения списка чатов                                                                 | [GetChats](https://green-api.com/docs/api/service/GetChats/)                                             |
